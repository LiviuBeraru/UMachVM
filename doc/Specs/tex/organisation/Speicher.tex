...
Die Tabelle \ref{tab:Interrupttabelle} gibt alle definierten
Interruptnummer\index{Interruptnummer} und deren Bedeutung wieder. Undefinierte
Interruptnummer werden nicht explizit angegeben.
