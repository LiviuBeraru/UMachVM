...
name={Assemblername},
description={Der Name eines Registers, so wie er in einem textuellen Programm
             erscheint. $R1$, $R2$ sind Assemblernamen von Registern.},
...
name={Maschinenname},
description={Der Name eines Registers, so wie er im Maschinencode erscheint.
            \texttt{0x01}, \texttt{0x02} sind Maschinennamen von Registern.},
