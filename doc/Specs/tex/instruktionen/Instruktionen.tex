...
\input{instruktionen/Verteilungstabelle}
...
$\mathbb{R}$, die die Menge aller reelen Zahlen bedeuten.}.
...
\input{instruktionen/kategorien/Kontrolle}
\input{instruktionen/kategorien/Lade-Speicher}
\input{instruktionen/kategorien/Arithmetik}
