...
auf den Befehl an der Adresse 0x000005e0 im Arbeitsspeicher der UMach~VM zeigt.
Der Inhalt der String-Variable ``promptdraw'' ist beginnend an der Adresse
0x00000784 gespeichert. Analog befindet sich an der Adresse 0x00000794 der
Inhalt der Integer-Variable ``newln''.
